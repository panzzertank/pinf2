...
function head_blog_is_preview() {
	...
	$active_theme	 = head_blog_get_raw_option( 'stylesheet' );
	// return apply_filters( 'head_blog_is_preview', ( $active_theme != strtolower( $theme_name ) && ! is_child_theme() ) ); 
	return apply_filters( 'head_blog_is_preview', ( $active_theme != strtolower( $theme_name ) ) );
}

// Get Raw Options
function head_blog_get_raw_option( $opt_name ) {
